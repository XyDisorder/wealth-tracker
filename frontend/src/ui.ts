...
function renderSummary(summary: WealthSummary | null): void {
...
function renderAccounts(accounts: AccountView[]): void {
...
function renderTimeline(timeline: TimelineResponse): void {
...
function showLoading(sectionId: string): void {
...
function showError(sectionId: string, error: Error): void {
  const content = document.getElementById(sectionId);
  if (content) {
